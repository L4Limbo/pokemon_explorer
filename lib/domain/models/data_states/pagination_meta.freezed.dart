...
class _$PaginationMetaImpl implements _PaginationMeta {
  const _$PaginationMetaImpl({required this.count, this.next, this.previous});
  ...
  @override
  String toString() {
    return 'PaginationMeta(count: $count, next: $next, previous: $previous)';
  }
...
abstract class _PaginationMeta implements PaginationMeta {
  const factory _PaginationMeta(
      ...
      final String? next,
      final String? previous}) = _$PaginationMetaImpl;
